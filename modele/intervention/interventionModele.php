...
class Intervention
{
    ...
    public function getNbInterventionUtilisateur($id, $statut)
    {
        $requete = 'SELECT COUNT(idintervention) FROM intervention WHERE (idclient = :id OR idtechnicien = :id) AND statut = :statut;';
    ...
    {
        $requete = 'SELECT SUM(prix_intervention) FROM intervention WHERE (idclient = :id OR idtechnicien = :id) AND statut = :statut;';
