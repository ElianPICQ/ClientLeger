...
?>		
		...
		<span><?php
		if ($unClient['date_naissance'] != null)
		{
			$currDate = date('Y-m-d');
...
<?php } ?>
		...
		<form method="post" action="controleur/traitement.php" >
			...
			<input name="currmdp" type="password" placeholder="Mot de Passe actuel" required />
			<input name="newmdp" type="password" placeholder="Nouveau Mot de Passe" required />
			<input name="newmdp2" type="password" placeholder="Retappez le nouveau Mot de Passe" required />
