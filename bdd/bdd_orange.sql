...
CREATE TABLE intervention (
    ...
    date_creation_intervention DATE NOT NULL,
    date_intervention_acceptee DATE,
...
CREATE VIEW lesInterventions AS (
    SELECT i.idintervention, p.nom_produit, p.etat, p.categorie, i.date_creation_intervention, i.date_intervention_acceptee,
...
INSERT INTO Utilisateur VALUES (null, "NOM", "Prenom", "client@mail.com", "0123456789", "123", "client");
...
INSERT INTO Utilisateur VALUES (null, "NOM", "Prenom", "admin@mail.com", "01010101", "123", "administrateur");